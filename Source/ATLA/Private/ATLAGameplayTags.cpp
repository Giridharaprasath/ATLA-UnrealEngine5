...
FATLAGameplayTags FATLAGameplayTags::GameplayTags;

void FATLAGameplayTags::InitializeNativeGameplayTags()
{
	/*
	 *	Primary Attributes
	 */
	...
	GameplayTags.Attributes_Secondary_StaminaRegeneration = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.StaminaRegeneration"), FString("Amount of Stamina regenerated every 1 second"));
